...
def save_model(model, save_folder, experiment_num):
    model_save_path = os.path.join(save_folder, f'model_epoch_{experiment_num}.pth')
...
if __name__ == '__main__':
    ...
    for e in range(args.experiment_num):
        ...
        save_model(model,
                   f'results/{args.data}-{args.input_type}/{args.model}/batch{args.batch}-testbattery{args.test_battery_id}/experiment{e + 1}',
                   e + 1)
    # multi_task_XJTU()
    # multi_task_MIT()
